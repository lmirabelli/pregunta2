...
icono = pygame.image.load("PREGUNTADOS/img/icono.png")
pygame.display.set_icon(icono)
fondo = pygame.image.load("PREGUNTADOS/img/fondo.png")
fondo = pygame.transform.scale(fondo, (ANCHO, ALTO))

# Sonidos
sonido_cash = pygame.mixer.Sound("PREGUNTADOS/sound/cash_sound.mp3")
sonido_cash.set_volume(1)
sonido_tambores = pygame.mixer.Sound("PREGUNTADOS/sound/tambores.mp3")
sonido_tambores.set_volume(0.2)
sonido_error = pygame.mixer.Sound("PREGUNTADOS/sound/sonido_error.mp3")
sonido_error.set_volume(0.2)

#MUSICA
pygame.mixer.init()
pygame.mixer.music.load("PREGUNTADOS\sound\musica.mp3")
pygame.mixer.music.set_volume(0.2)
pygame.mixer.music.play()

# Cargar imagen de fondo para la pregunta
fondo_pregunta = pygame.image.load("PREGUNTADOS/img/fondo_pregunta.png")
fondo_pregunta = pygame.transform.scale(fondo_pregunta, (650, 100))  # Ajustar tamaño

# Cargar texturas para las opciones
imagen_opcion_default = pygame.image.load("PREGUNTADOS/img/opcion_default.png")
imagen_opcion_correcta = pygame.image.load("PREGUNTADOS/img/opcion_correcta.png")
imagen_opcion_incorrecta = pygame.image.load("PREGUNTADOS/img/opcion_incorrecta.png")
...
preguntas = cargar_preguntas("PREGUNTADOS/preguntas.json")
pregunta_actual = 0
...
while ejecutando:
    ...
    mostrar_texto(f"{tiempo_actual}s", 500, 90)
